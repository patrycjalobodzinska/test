...
import {
  editProcurementRequirements,
  editProcurementRequirementsFormFields,
  editProcurementRequirementsResponse,
  editProcurementRequirementsSchema,
} from "@/api/tenders/putProcurementRequirements";
...
const EditContract: NextPageWithLayout = () => {
  ...
  const { methods, handleSubmit, isLoading } = useFormMutation<
    editProcurementRequirementsFormFields,
    editProcurementRequirementsResponse
  >(editProcurementRequirementsSchema, editProcurementRequirements, {
    onSuccess() {
          ...
          <form
            ...
            <div className="flex items-end justify-end border-b pb-4">
              {newCriteria ? (
                ...
                <Button type="button" onClick={handleeditCriteria}>
                  Dodaj kryterium
                </Button>
              )}
            </div>
...
EditContract.getLayout = (page) => <Layout>{page}</Layout>;
